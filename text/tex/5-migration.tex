...
Finally, we implemented a ROS~2 node called "teensy_drive"\urlnote{https://github.com/pokusew/f1tenth-rewrite/tree/main/src/vehicle_platform/teensy_drive} that connects to the Teensy via USB (CDC-ACM) and receives and send appropriate messages between Teensy and the ROS~2 network.
