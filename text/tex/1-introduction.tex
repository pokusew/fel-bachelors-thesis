...
{\sbf Note:} I severely underestimated the required time for writing this thesis text. During my work on this topic, I tried and made work tons of different things, leaving too little time for the final write-up. This is the reason why chapters \ref[tracing] and \ref[evaluation] are incomplete. However, this thesis has a~homepage\urlnote{https://github.com/pokusew/fel-bachelors-thesis} on GitHub, where an up-to-date revision of this text can be found.
...
\midinsert
\picw=8cm \cinspic ../images/tx2-auto-usa.png
\caption/f One of the CTU's F1/10 Autonomous Model Cars.
\endinsert
...
\sec[intro_motivation] Motivation / Why migrate to ROS~2?
